...
export default function WeightCalculatorPage({ params }: WeightPageProps) {
  const calculatorInfo =
    WEIGHT_CALCULATORS[params.type as keyof typeof WEIGHT_CALCULATORS];
