export const traitItems: {
...
}[] = [
  {
    ...
    icon: 'PhoneCall',
    description:
      'ارتباط با مشاوران فروش جهت مشاوره و خرید از طریق تماس با شماره 09125858047 جهت اطمینان خاطر از روند خرید.',
  },
  {
    id: 1,
  ...
  {
    id: 2,
    title: 'فروش با ضمانتنامه بانکی و LC',
    icon: 'Banknote',
    description:
