...
export default function ProductPage({
  ...
  const [selectedOrderProduct, setSelectedOrderProduct] = useState<Product | null>(
    null,
  )
  ...
  const formatPrice = (price: number) => {
    return new Intl.NumberFormat('fa-IR').format(Math.round(calculatePrice(price)))
  }
      ...
      <div className='text-white bg-gradient-to-r from-blue-600 to-blue-800'>
        <div className='px-6 py-12 mx-auto max-w-7xl'>
          <div className='text-center'>
            ...
            {description && (
              <p className='max-w-3xl mx-auto text-xl opacity-90'>{description}</p>
            )}
